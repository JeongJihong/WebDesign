<template>
    <div id="kakao-login">
        ...
        <button @click="kakaoLogin" style="width:100%" class="my-2">
    <!-- <div id="kakao-login"> -->
            ...
            <!-- <div class="d-flex flex-row justify-content-between">
                <div>
                    <span style="font-size: 0.8rem;">간편로그인</span>
                </div>
                <div>
                    <img src="//k.kakaocdn.net/14/dn/btqCn0WEmI3/nijroPfbpCa4at5EIsjyf0/o.jpg" style="height: 2.7rem; width: 100%; margin-bottom:10px;">
                        <g id="그룹_247" data-name="그룹 247" transform="translate(-237 -406)">
                            <g id="구성_요소_2" data-name="구성 요소 2" transform="translate(237 406)">
                                <g id="타원_6" data-name="타원 6" fill="#ffd800" stroke="#eee" stroke-width="1">
                                    <circle cx="27.5" cy="27.5" r="27.5" stroke="none"/>
            ...
            <div>
                ...
                ><b-icon icon="chat-fill"></b-icon>  카카오계정으로 로그인</button>
            </div>
    </div>
</template>
