...
export default {
  ...
  created() {
    axios({
        url:`http://i5b302.p.ssafy.io/api/article/`+this.$route.params.articleid+`/comment`,
        method:'get',
        headers: {
  ...
  methods: {
    ...
    getComments: function(){
      axios({
        url:`http://i5b302.p.ssafy.io/api/article/1/comment`,
        method:'get',
        headers: {
          'x-auth-token': `${localStorage.getItem('token')}`,
        },
    ...
    CommentDelete(commentid){
      axios({
        url:`http://i5b302.p.ssafy.io/api/article/comment/`+commentid,
        method:'delete',
        headers: {
          'x-auth-token': `${localStorage.getItem('token')}`,
        }
