  ...
  methods:{
    ...
    getwaitingPromiseFeeImgUrl(payload) {
      ...
      return {
        ...
        icon: this.waitingPromises[payload.idx] && require(`https://i5b302.p.ssafy.io/img/${payload.imgURL}-icon.svg`)
      }
    },
    getupcomingPromisesFeeImgUrl(payload) {
      ...
      return {
        ...
        icon: this.upcomingPromises[payload.idx] && require(`https://i5b302.p.ssafy.io/img/${payload.imgURL}-icon.svg`)
      }
    }
  }
}
